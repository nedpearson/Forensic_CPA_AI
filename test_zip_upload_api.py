...
s = requests.Session()
s.post('http://localhost:3004/api/auth/login', json={'email':'nedpearson@gmail.com','password':'1Pearson2'})

# get companies and switch
...
# check documents api to see if individual files are shown
